...
# 图表列表，前面加个 u 竟然就好使了
graph_list = [('1',u'营业收入与净利润率'),('2',u'收入与利润增长率'),('3',u'资本结构与权益乘数'),('4',u'净资产收益率与公司价值估计'),('5',u'均衡相对估值水平'),('6',u'营运资本周转情况'),('7',u'利润率状况'),('8',u'投入资本回报率与总资产收益率'),('9',u'资产规模与总资产周转率'),('10',u'净资产与净资产收益率'),('11',u'现金流状况'),('12',u'雇员数量')]
class graph_Form(Form):
    graph_id = SelectField('graph_id',choices=graph_list)
    year_id = SelectField('year_id',choices=[('10',u'10年'),('15',u'15年')])
